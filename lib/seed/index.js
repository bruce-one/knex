...
Seeder.prototype._listAll = Promise.method(function (config) {
  ...
  return Promise.promisify(fs.readdir, { context: fs })(this._absoluteConfigDir()).bind(this).then(function (seeds) {
    return _filter(seeds, function (value) {
...
Seeder.prototype._runSeeds = function (seeds) {
  return Promise.all(_map(seeds, _bind(this._validateSeedStructure, this))).bind(this).then(function (seeds) {
