...
var Transaction = function (_EventEmitter) {
  ...
  function Transaction(client, container, config, outerTx) {
    ...
    var txid = _this.txid = _uniqueId('trx');
    ...
    _this._promise = Promise.using(_this.acquireConnection(client, config, txid), function (connection) {
    ...
    _this._previousSibling = Promise.resolve(true);
    if (outerTx) {
...
function makeTxClient(trx, client, connection) {
  ...
  var trxClient = _Object$create(client.constructor.prototype);
