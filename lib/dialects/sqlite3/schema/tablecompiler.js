...
TableCompiler_SQLite3.prototype.primaryKeys = function () {
  var pks = _filter(this.grouped.alterTable || [], { method: 'primary' });
...
TableCompiler_SQLite3.prototype.foreignKeys = function () {
  var sql = '';
  var foreignKeys = _filter(this.grouped.alterTable || [], { method: 'foreign' });
...
TableCompiler_SQLite3.prototype.dropColumn = function () {
  var compiler = this;
  var columns = _Object$values(arguments);
  this.pushQuery({
    sql: 'PRAGMA table_info(' + this.tableName() + ')',
    output: function output(pragma) {
